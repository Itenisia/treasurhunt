...
class Upgrade(models.Model):
    ...
    unit_types = models.ManyToManyField("UnitType", blank=True, related_name="upgrades")
    attack_bonus = models.IntegerField(default=0)
    attack_bonus_pct = models.FloatField(default=0.0, help_text="Bonus d'attaque en pourcentage (0.1 = +10%)")
